...
- Program the mBot to follow simple routes using ordered commands, turns, timing, and speed.
- Use loops, outputs, sensors, and if/then logic in guided robot tasks.
- Draw route maps and condition flowcharts to explain and improve robot behavior.
...
| route | The path used to get from one place to another. |
| accurate | Correct and close to the target. |
| marker | An object or line used to show a place. |

#### July Week 2 - Repeat Patterns
...
| zigzag | A path that turns left and right again and again. |
| shorter | Using less length, time, or space. |

#### July Week 3 - Sensor Detection
...
| line | A long mark or path to follow. |
| input | Information or an action that goes into a device or program. |
| response | What happens after an input or condition. |

#### July Week 4 - Conditions and Flowcharts

| Word | Simple definition |
| --- | --- |
| if | A word used to start a condition. |
...
| --- | --- | --- | --- | --- | --- |
| Week 5 | 45 minutes | Movement review | Answer the warm-up question: What commands did you use in June?<br>Review July Week 1 practice vocabulary (part 1). speed: how fast something moves time: how long something lasts turn: change direction sequence: steps in order Predict the route made by a short command list. | Practice drawing a short mBot route map with movement steps and labeled turns.<br>Compare your practice route with a partner. Review the route map and command plan expectations before the next class. | Compare your route map with a partner. Circle one step that must be very accurate. |
| Week 5 | 90 minutes | Path challenge 2 | Review July Week 1 practice vocabulary with Blooket or a crossword puzzle (part 2). route: path to a place accurate: correct and close to target marker: object or line showing a place Choose one mBot Knowledge Card connected to movement. | Complete Summative Activity #3: Draw an mBot route map with at least 4 movement steps, write the command sequence, and label each turn or stop point. Submit the route map and command plan in class or on Google Classroom.<br>Program mBot through a route with at least three moves. Test each section of the route. Debug one movement that is not accurate. Improve the route after testing. | Demonstrate one working sequence. Write what you debugged. |
| Week 6 | 45 minutes | Loops as repeated actions | Answer the warm-up question: What actions do you repeat every day? Review July Week 2 practice vocabulary (part 1). repeat: do again loop: code that repeats pattern: repeated design or action Find repeated actions in a sample robot path. | Act out a repeated command pattern. Rewrite a repeated command list using the word repeat. Predict how a loop can make a program shorter. | Write one sentence explaining what a loop does. Share one repeated robot action. |
| Week 6 | 90 minutes | Repeat patterns | Complete a vocabulary review activity using July Week 2 practice vocabulary (part 2). square: shape with four equal sides zigzag: path that turns left and right shorter: using less space or time Review the mBot card or block connected to repeated actions. | Program a repeated movement pattern, such as a square or zigzag. Test the pattern and adjust one value. Add an LED or buzzer signal at the end if time allows. Compare the long version and loop version of the program. | Show the repeated movement pattern. Explain how the loop helped. |
| Week 7 | 45 minutes | Sensors around us | Answer the warm-up question: What senses do humans use? Review July Week 3 practice vocabulary (part 1). sensor: part that detects something detect: notice or find obstacle: thing in the way Match each sensor word with what it detects. | Identify the available mBot sensor on your robot or card. Describe what the sensor can detect. Record one real-life example of a sensor. | Complete one exit question: What does a sensor do? Share one sensor example. |
| Week 7 | 90 minutes | mBot sensor practice | Complete a word soup or matching activity using July Week 3 practice vocabulary (part 2). line: long mark or path input: information or action going in response: what happens after Review the mBot Knowledge Card connected to the available sensor. | Observe how the sensor reacts to an object or line. Test the sensor in two different situations. Record what changed in each test. Create one simple response using the sensor. | Demonstrate one sensor response. Write what the sensor detected. |
| Week 8 | 45 minutes | Simple conditions | Answer the warm-up question: What happens if it rains? Review July Week 4 practice vocabulary (part 1). if: starts a condition condition: rule that is checked response: what happens after Complete three everyday if/then sentences. | Practice building an if/then flowchart with a sample sensor condition, true response, and false response. Review the condition flowchart expectations before the next class. | Share the condition and response from your flowchart. Write one sentence explaining why conditions help robots make decisions. |
| Week 8 | 90 minutes | Obstacle or line challenge | Review July Week 4 practice vocabulary with Blooket or a crossword puzzle (part 2). true: correct or happening false: not correct or not happening flowchart: diagram of steps or choices Check your planned condition and response. | Complete Summative Activity #4: Create an if/then flowchart with one mBot sensor condition, one true response, one false response, and one sentence explaining the robot behavior. Submit the completed flowchart in class or on Google Classroom. Program one sensor-triggered behavior. Test the behavior in the challenge area. Debug one problem with the condition or response. Improve the behavior after testing. | Show one working sensor response. Record one test result and one improvement. |
| Week 9 | 45 minutes | Plan a mini-challenge | Answer the warm-up question: What should your robot do by the end of the challenge?<br>Review July Week 5 practice vocabulary with a quick matching activity. test area: space used for trying work commands: program instructions blocks: coding pieces<br>Choose a realistic goal using movement plus one output or sensor. | Plan your mini-challenge with a goal, commands, test area, and success rule. List the mBot cards or blocks you will need. Check that your goal is possible in class time. | Submit your mini-challenge plan. Write one question you need to solve next class. |
| Week 9 | 90 minutes | mBot mini-challenge practice | Review your mini-challenge plan. Prepare the robot, cards, and test area.<br>Review July Week 5 practice vocabulary with a quick matching activity. challenge: task that takes effort goal: what you are trying to do success rule: rule that says the task worked | Build and test your chosen mini-challenge. Record one problem and one improvement. Ask another group to watch your test and give one suggestion. Improve your program after feedback. | Demonstrate your best attempt. Reflect on what you will improve in August. |
