---
title: "8th Grade Technology — 8A and 8B Thu Oct 29 — 90 minutes"
trimester: 3
year: 2026
week: 7
schedule: "8A and 8B Thu Oct 29 — 90 minutes"
duration: "90 minutes"
topic: "Python arithmetic and output practice"
---

# 8th Grade Technology — 8A and 8B Thu Oct 29 — 90 minutes

## Class Snapshot

| Item | Details |
|---|---|
| Scheduled group/date/duration | 8A and 8B Thu Oct 29 — 90 minutes |
| Topic | Python arithmetic and output practice |
...
Complete the fixed arithmetic/output program and tests.
...
Practice only; save the .py file and test record for feedback before debugging assessment.
