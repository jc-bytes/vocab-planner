...
| Continuity | Strong | Robotics builds toward mBot Maze Navigator; media/Scratch builds toward the Scratch Rhythm Game; spreadsheets/media/micro:bit build toward Mandrake Detection System. |
...
| 2nd Trimester | #1 poster/media vocabulary table, #2 environmental poster, #3 branded mini-presentation, #4 Scratch sequence and variable program, #5 reference rhythm-game code walkthrough | #1 constructive peer feedback, #2 pair-programming responsibility | Scratch Rhythm Game |
...
| July | 5 | Scratch selection, operators, loops, code tracing, reference rhythm-game analysis and presentation | 1 daily, 2 appreciation | Teachable; the guided reference project gives students a concrete bridge into the exam. |
| August | 4 | Four-lane Scratch Rhythm Game project | exam project | Feasible with the teacher-provided common format, starter lane, and bounded feature list. |
...
5. Scratch Rhythm Game exam project.
...
- Students practice sequence, variables, conditions, loops, code tracing, and pair-programming before the project.
- The Week 8 code-walkthrough presentation requires students to explain the teacher-provided reference game before building their own version.
- August gives a full project build and presentation window.

Risks:

- Four lanes, moving targets, collision checks, timing, variables, music, and feedback can become too large if students begin without a common starter structure.

Guardrail:

- Keep the required product to the common D/F/J/K format: four lanes, one working target pattern per lane, collision-based hits, a clear miss rule, score, time, tempo, feedback, start/end conditions, three documented tests, and a short code explanation. Provide one starter lane when needed.
