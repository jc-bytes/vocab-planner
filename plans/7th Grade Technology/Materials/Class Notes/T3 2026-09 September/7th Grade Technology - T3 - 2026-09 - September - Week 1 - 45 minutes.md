...
week: 1
duration: 45 minutes
groups-and-dates: "7A — Sep 16 — 45 minutes / 7B — Sep 17 — 45 minutes"
---

# 7A — Sep 16 — 45 minutes / 7B — Sep 17 — 45 minutes
...
| --- | --- |
| Week | 1 |
| Group, date, duration | 7A — Sep 16 — 45 minutes / 7B — Sep 17 — 45 minutes |
| Topic | Spreadsheet cell references |
| Assessment status | D1 |

## Objective

Practice rows, columns, cells, and references.

## Before

- Project [Class Visuals](../../Lesson%20Packages/T3%202026/Class%20Visuals.html#w1-45).
- Open `MOD-SPREADSHEET-ANALYSIS-01` or distribute the named fixed task/fallback.
...
- **Collect:** Corrected practice sheet.
