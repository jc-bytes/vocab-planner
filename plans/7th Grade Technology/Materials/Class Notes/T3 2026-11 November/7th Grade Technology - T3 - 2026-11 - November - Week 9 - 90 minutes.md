...
week: 9
duration: 90 minutes
groups-and-dates: "7A and 7B — Nov 13 — 90 minutes"
---

# 7A and 7B — Nov 13 — 90 minutes
...
| --- | --- |
| Week | 9 |
| Group, date, duration | 7A and 7B — Nov 13 — 90 minutes |
| Topic | Mandrake Detection System Design Plan milestone |
| Assessment status | EXAM |

## Objective

Complete the fixed Mandrake design milestone as exam-process evidence, not a Daily grade.

## Before

- Project [Class Visuals](../../Lesson%20Packages/T3%202026/Class%20Visuals.html#w9-90).
- Open `Mandrake Project packet` or distribute the named fixed task/fallback.
