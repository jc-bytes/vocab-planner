...
week: 4
duration: 90 minutes
groups-and-dates: "7A and 7B — Oct 9 — 90 minutes"
---

# 7A and 7B — Oct 9 — 90 minutes
...
| --- | --- |
| Week | 4 |
| Group, date, duration | 7A and 7B — Oct 9 — 90 minutes |
| Topic | STEAM project development |
| Assessment status | Formative STEAM |

## Objective

Complete the assigned project checkpoint and work log.

## Before

- Project [Class Visuals](../../Lesson%20Packages/T3%202026/Class%20Visuals.html#w4-90).
- Open `../../../../Shared Materials/T3 2026 STEAM Kit` or distribute the named fixed task/fallback.
...
- **Collect:** Shared-kit formative work log.
