...
week: 7
duration: 45 minutes
groups-and-dates: "7A — Oct 28 — 45 minutes / 7B — Oct 29 — 45 minutes"
---

# 7A — Oct 28 — 45 minutes / 7B — Oct 29 — 45 minutes
...
| --- | --- |
| Week | 7 |
| Group, date, duration | 7A — Oct 28 — 45 minutes / 7B — Oct 29 — 45 minutes |
| Topic | Source and image-credit practice |
| Assessment status | Formative practice |

## Objective

Practice author, date, evidence, purpose, and four-part credit checks.

## Before

- Project [Class Visuals](../../Lesson%20Packages/T3%202026/Class%20Visuals.html#w7-45).
- Open `assigned module/fixed practice` or distribute the named fixed task/fallback.
...
- **Collect:** Corrected fixed-card practice.
