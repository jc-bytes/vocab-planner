...
week: 13
duration: 90 minutes
groups-and-dates: "7A and 7B — Dec 11 — 90 minutes"
---

# 7A and 7B — Dec 11 — 90 minutes
...
| --- | --- |
| Week | 13 |
| Group, date, duration | 7A and 7B — Dec 11 — 90 minutes |
| Topic | School exams and Technology make-up |
| Assessment status | No new assessment |

## Objective

Complete only an approved make-up or administrative task; no new Technology assessment.

## Before

- Project [Class Visuals](../../Lesson%20Packages/T3%202026/Class%20Visuals.html#w13-90).
- Open `None` or distribute the named fixed task/fallback.
