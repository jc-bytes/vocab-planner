# Daily Grade 5 fixed Mandrake design template
...
Assigned parts: micro:bit/controller, ultrasonic sensor, Bluetooth message, computer or second micro:bit receiver/simulator, sound output, power/data cable, stable nonliving model, and labeled safe base.
...
|---|---|---|
| Input | Ultrasonic sensor/distance reading | |
...
| Required test | Distance | Expected Bluetooth result | Expected sound result | Safe/setup condition |
|---|---:|---|---|---|
| Below | 17 cm | | | |
| At | 18 cm | | | |
| Above | 19 cm | | | |

Filename: `Lastname_Firstname_7A-or-7B_Daily5_MandrakePlan`
