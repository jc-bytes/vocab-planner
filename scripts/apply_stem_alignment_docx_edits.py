...
def main():
    ...
    update_docx(
        "plans/6th Grade Technology/6th Grade Monthly Planning/2nd Trimester/6° Technology - August.docx",
        meta={
            1: (
                "Competences:\n"
    ...
    update_docx(
        "plans/6th Grade Technology/6th Grade Monthly Planning/3rd Trimester/6° Technology - September.docx",
        weeks=3,
        meta={
            1: (
                "Competences:\n"
    ...
    update_docx(
        "plans/6th Grade Technology/6th Grade Monthly Planning/3rd Trimester/6° Technology - October.docx",
        meta={
            1: (
                "Competences:\n"
