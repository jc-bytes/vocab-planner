...
| 18. Migrate remaining teacher features | IN PROGRESS | Groups, Word Hunt Review, and Sparks explicit factories; shared loaded-feature disposal; Quiz state isolation; tests and browser workflows | Per-feature focused/full suites, lazy adapter workflows, production builds, built-page smoke, independent reviews | Groups, Word Hunt Review, and Sparks are migrated. Quiz navigation is isolated as a tested factory prerequisite; Quiz lifecycle and Data Management remain. |
