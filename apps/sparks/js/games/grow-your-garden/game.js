...
class GardenGame {
    ...
    // Get garden data for local exports and backups
    getGardenData() {
        return {
            money: this.money,
            water: this.water,
    ...
    // Save local game state when leaving the arcade game
    logout() {
        this.saveGame();
    }
            ...
            <div style="margin-bottom: 20px;">
                ...
                <div style="background: #e8f5e8; padding: 15px; border-radius: 8px; margin-bottom: 20px;">
                    ...
                    <ul style="margin-left: 20px;">
                        ...
                        <li>Garden display issues</li>
                        <li>Save slot problems</li>
                    </ul>
                </div>
...
// Initialize the menu system directly for the arcade-embedded offline version.
let menuSystem;
document.addEventListener('DOMContentLoaded', () => {
    console.log('DOM Content Loaded - initializing offline arcade game...');
