...
export function installTeacherQuizMethods(TeacherManager) {
    for (const name of Object.getOwnPropertyNames(TeacherQuizMethods.prototype)) {
        if (name === 'constructor') continue;
        Object.defineProperty(
            TeacherManager.prototype,
            name,
            Object.getOwnPropertyDescriptor(TeacherQuizMethods.prototype, name)
        );
    }
}
